...
private let goldenCloudStandardText = """
    ...
    - Resolve self-corrections, keeping ONLY the corrected version and deleting the abandoned words and the cue itself. Phrases like "I mean", "I meant", "actually", "no wait", "wait no", "sorry", "rather", "make that", "scratch that", "correction", or "never mind" right after a word or phrase signal the speaker is replacing it. A cue used as an ordinary word ("this is actually fine", "the correction was applied") is NOT a correction; leave that sentence as spoken:
      ...
      "send the draft to legal, correction, to finance" → "send the draft to finance"
